    ...
    <>
      ...
      <section className="section section--brand-story" id="ueber-uns">
        <div className="brand-story-mobile-bg">
          <Image src="/images/audi-rs3-fahrzeugaufbereitung-halle-nettelkofen-frontal-2.webp" alt="Audi RS3 Frontalansicht in der Aufbereitungshalle Steinegger Nettelkofen bei Grafing – professionelle Fahrzeugpflege" fill className="brand-story-mobile-bg__img" sizes="100vw" quality={60} priority />
        ...
        <div className="container brand-story">
          <ScrollReveal direction="left" className="brand-story__img-col">
            <div className="brand-story__img-wrap">
              ...
              <Image src="/images/audi-rs3-fahrzeugaufbereitung-halle-nettelkofen-frontal-2.webp" alt="Audi RS3 Frontalansicht bei professioneller Fahrzeugaufbereitung – Steinegger Halle Nettelkofen bei Grafing" width={600} height={750} className="brand-story__img" sizes="(max-width: 768px) 100vw, 50vw" quality={75} />
            </div>
          </ScrollReveal>
